...
object Messages {
    ...
    const val START_RECOMMENDING_LUNCH_MENU = "점심 메뉴 추천을 시작합니다."

    const val INPUT_COACH_NAMES = "코치의 이름을 입력해 주세요. (, 로 구분)"
    const val INPUT_IMPOSSIBLE_MENU = "(이)가 못 먹는 메뉴를 입력해 주세요."

    const val PRINT_RESULT_COMMENT = "메뉴 추천 결과입니다.\n[ 구분 | 월요일 | 화요일 | 수요일 | 목요일 | 금요일 ]"
    ...
    const val ERROR_DIFFERENT_FROM_THE_SET_MENU = "[ERROR] 정해진 메뉴에서 벗어난 메뉴입니다."
    const val ERROR_TWO_MENUS_OVER = "[ERROR] 2개이상의 메뉴를 입력하였습니다."
